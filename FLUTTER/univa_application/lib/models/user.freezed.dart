...
mixin _$User {
  ...
  Map<String, dynamic>? get faculty => throw _privateConstructorUsedError;
...
class _$UserImpl implements _User {
  ...
  final Map<String, dynamic>? _faculty;
  @override
  Map<String, dynamic>? get faculty {
    final value = _faculty;
    if (value == null) return null;
    if (_faculty is EqualUnmodifiableMapView) return _faculty;
  ...
  @override
  String toString() {
    return 'User(id: $id, name: $name, username: $username, email: $email, student: $student, faculty: $faculty)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, username, email,
      student, const DeepCollectionEquality().hash(_faculty));
...
abstract class _User implements User {
  const factory _User(
      ...
      final String? email,
      final Student? student,
      final Map<String, dynamic>? faculty}) = _$UserImpl;
