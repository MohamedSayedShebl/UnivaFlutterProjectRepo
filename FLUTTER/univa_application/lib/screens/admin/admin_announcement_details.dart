...
class _AnnouncementDetailScreenState extends State<AnnouncementDetailScreen> {
  ...
  void _toggleEdit(Announcement announcement) {
    setState(() {
  ...
  void _saveChanges() {
    ...
    context.read<AnnouncementCubit>().updateAnnouncement(widget.announcementId, data);
        ...
        appBar: AppBar(
          ...
          actions: [
            BlocBuilder<AnnouncementCubit, AnnouncementState>(
              builder: (context, state) {
                return state.maybeWhen(
                  detail: (announcement) => IconButton(
                    icon: Icon(_isEditing ? Icons.save : Icons.edit),
                    onPressed: () {
                      if (_isEditing) {
                        _saveChanges();
                      } else {
                        _toggleEdit(announcement);
                      }
                    },
                  ),
            ...
            IconButton(
              ...
              onPressed: () {
                context.read<AnnouncementCubit>().deleteAnnouncement(widget.announcementId);
              },
            ),
          ],
        ),
